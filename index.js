...
// console.log(createMenuItem("Spagetti", 10, "Dinner"));
// console.log(createMenuItem("Chicken Parmanara", 15, "Dinner"));
...
reviews.push({ name: "Reuben", rating: 3.5, feedback: "Epic food!" });
...
function getLongReviews(arr) {
  tempArr = [];
  for (let i = 0; i < arr.length; i++) {
    if (wordCounter(arr[i].feedback) >= 15) {
      tempArr.push(arr[i]);
    }
  }
